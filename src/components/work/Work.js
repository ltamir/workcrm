...
const Work = ({lesson, clickHandler, changeStatus, showPayment, editLesson, navToPayment}) =>{
	...
	const editWork = () => {
		history.push(`/workcrm/customers/${lesson.customerId}/works/${lesson.id}`);
	}
	...
	<div 
		...
		<div className="LessonRow">
			...
			<div style={{marginLeft: 'auto'}}> <Button label='EDIT WORK' onClick={editWork}/></div>
		</div>
